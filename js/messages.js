var messages = {
  ...
  gridGarden: {
    ...
    'bs': 'Želiš nagovještaj? Pročitaj MDN stranicu za ',
    'hr': 'Želiš li savjet? Pročitaj MDN stranicu za ',
    'ro': 'Vrei un indiciu? Citește pagina MDN pentru ',
    'de': 'Willst du einen Hinweis? Lies die MDN-Seite für ',
    'fr': 'Vous voulez un indice ? Lisez la page MDN pour ',
    'pt-br': 'Quer uma dica? Leia a página da MDN para ',
    'ru': 'Хотите подсказку? Прочитайте страницу MDN для ',
    'nl': 'Wil je een hint? Lees de MDN-pagina voor ',
    'ta': 'குறிப்பு வேண்டுமா? MDN பக்கத்தைப் படியுங்கள் ',
    'ml': 'ഒരു സൂചന വേണോ? MDN പേജ് വായിക്കുക ',
    'el': 'Θέλετε μια συμβουλή; Διαβάστε τη σελίδα MDN για ',
    'mk': 'Сакате помош? Прочитајте ја MDN страницата за ',
    'lv': 'Vajadzīgs mājiens? Lasi MDN lapu par ',
    'it': 'Vuoi un suggerimento? Leggi la pagina MDN per ',
    'pl': 'Chcesz podpowiedź? Przeczytaj stronę MDN dla ',
    'id': 'Ingin petunjuk? Baca halaman MDN untuk ',
    'ar': 'تريد تلميح؟ اقرأ صفحة MDN لـ ',
    'ca': 'Vols una pista? Llegeix la pàgina MDN per a ',
    'da': 'Vil du have et tip? Læs MDN-siden for ',
    'et': 'Soovid vihjet? Loe MDN lehte ',
    'fi': 'Haluatko vihjeen? Lue MDN-sivu ',
    'tr': 'İpucu ister misiniz? MDN sayfasını okuyun: ',
    'az': 'İpucu istəyirsiniz? MDN səhifəsini oxuyun: ',
    'gl': 'Queres unha pista? Le a páxina de MDN para ',
    'uk': 'Хочеш підказку? Прочитай сторінку MDN для ',
    'th': 'ต้องการคำใบ้ไหม? อ่านหน้า MDN สำหรับ ',
    'mn': 'Зөвлөгөө хэрэгтэй юу? MDN хуудсыг уншина уу: ',
    'sk': 'Chcete nápovedu? Prečítajte si stránku MDN pre ',
    'si': 'ඉඟියක් අවශ්‍යද? MDN පිටුව කියවන්න ',
    'bn': 'একটি ইঙ্গিত চান? এর জন্য MDN পৃষ্ঠা পড়ুন ',
    'np': 'संकेत चाहनुहुन्छ? को लागी MDN पृष्ठ पढ्नुहोस् ',
    'my': 'အရိပ်အမြွက်လိုချင်ပါသလား? MDN စာမျက်နှာကို ဖတ်ပါ ',
    'yo': 'Ṣé o fẹ́ ìdámọ̀ràn? Ka ojú ewé MDN fún ',
  },
  labelLanguage: {
    'en': 'Language',
    'af': 'Taal',
